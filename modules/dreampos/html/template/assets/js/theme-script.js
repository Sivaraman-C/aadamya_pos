                        ...
                        <div class="row gx-3">
                                ...
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="defaultLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="<?php echo base_url(); ?>modules/assets/img/theme/default.svg" alt="img">
                                        </span>                                     
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="miniLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="<?php echo base_url(); ?>modules/assets/img/theme/mini.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="twocolumnLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="<?php echo base_url(); ?>modules/assets/img/theme/two-column.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontalLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="<?php echo base_url(); ?>modules/assets/img/theme/horizontal.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="detachedLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="<?php echo base_url(); ?>modules/assets/img/theme/detached.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="without-headerLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="<?php echo base_url(); ?>modules/assets/img/theme/without-header.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <a href="layout-rtl.html" class="theme-layout mb-3">
                                    <span class="d-block mb-2 layout-img">
                                        <img src="<?php echo base_url(); ?>modules/assets/img/theme/rtl.svg" alt="img">
                                    </span>                                    
                       ...
                       <div class="d-flex align-items-center flex-wrap">
                            <div class="theme-sidebarbg me-3 mb-3">
                                ...
                                <label for="sidebarBg1" class="d-block rounded">
                                    <img src="<?php echo base_url(); ?>modules/assets/img/theme/sidebar-bg-01.svg" alt="img" class="rounded">
                                </label>
                            </div>
                            <div class="theme-sidebarbg me-3 mb-3">
                                <input type="radio" name="sidebarbg" id="sidebarBg2" value="sidebarbg2">
                                <label for="sidebarBg2" class="d-block rounded">
                                    <img src="<?php echo base_url(); ?>modules/assets/img/theme/sidebar-bg-02.svg" alt="img" class="rounded">
                                </label>
                            </div>
                            <div class="theme-sidebarbg me-3 mb-3">
                                <input type="radio" name="sidebarbg" id="sidebarBg3" value="sidebarbg3">
                                <label for="sidebarBg3" class="d-block rounded">
                                    <img src="<?php echo base_url(); ?>modules/assets/img/theme/sidebar-bg-03.svg" alt="img" class="rounded">
                                </label>
                            </div>
                            <div class="theme-sidebarbg me-3 mb-3">
                                <input type="radio" name="sidebarbg" id="sidebarBg4" value="sidebarbg4">
                                <label for="sidebarBg4" class="d-block rounded">
                                    <img src="<?php echo base_url(); ?>modules/assets/img/theme/sidebar-bg-04.svg" alt="img" class="rounded">
                                </label>
                            </div>
                            <div class="theme-sidebarbg me-3 mb-3">
                                <input type="radio" name="sidebarbg" id="sidebarBg5" value="sidebarbg5">
                                <label for="sidebarBg5" class="d-block rounded">
                                    <img src="<?php echo base_url(); ?>modules/assets/img/theme/sidebar-bg-05.svg" alt="img" class="rounded">
                                </label>
                            </div>
                            <div class="theme-sidebarbg me-3 mb-3">
                                <input type="radio" name="sidebarbg" id="sidebarBg6" value="sidebarbg6">
                                <label for="sidebarBg6" class="d-block rounded">
                                    <img src="<?php echo base_url(); ?>modules/assets/img/theme/sidebar-bg-06.svg" alt="img" class="rounded">
                                </label>
                            </div>
                        </div>
                    </div>
