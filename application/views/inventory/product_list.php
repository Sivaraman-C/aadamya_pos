		...
		<div class="content">
			<div class="page-header">
				...
				<ul class="table-top-head">
					...
					<li>
						<a href="javascript:void(0);" onclick="exportAllPagesToExcel('product-table')" title="Export All to Excel">
				...
				<div class="page-btn">
					<a href="<?php echo base_url('add_product'); ?>" class="btn btn-primary"><i class="ti ti-circle-plus me-1"></i>Add Product</a>
				</div>
			</div>
			
			<table id="product-table" class="table datatable">
		        <thead>
		            <tr>
						<th>Id </th>
						<th>Product Name</th>
...
async function exportTableToPDF() {
  ...
  const headers = $('#product-table thead th').toArray()
    .slice(0, -1)
    .map(th => $(th).text().trim());
...
// Excel
  ...
  function exportAllPagesToExcel(tableID, filename = 'all_products.xlsx') {
