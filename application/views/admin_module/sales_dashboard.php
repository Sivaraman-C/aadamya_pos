			...
			<div class="content">
				<div class="welcome d-lg-flex align-items-center justify-content-between">
					<div class="d-flex align-items-center welcome-text">
						<h3 class="d-flex align-items-center"><img src="modules/assets/img/icons/hi.svg" alt="img">&nbsp;Hi John Smilga,</h3>&nbsp;<h6>here's what's happening with your store today.</h6>
					</div>
				...
				<div class="row sales-cards">
					<div class="col-xl-6 col-sm-12 col-12 d-flex">
						<div class="card d-flex align-items-center justify-content-between flex-fill mb-4">
							<div>
								...
								<h3><i class="fa-solid fa-indian-rupee-sign"></i> <span class="counters" data-count="95000.45">95000.45</span></h3>
							...
							<img src="modules/assets/img/icons/weekly-earning.svg" alt="img">
						</div>
					</div>
					<div class="col-xl-3 col-sm-6 col-12 d-flex">
						<div class="card color-info bg-primary flex-fill mb-4">
							<div class="mb-2">
								<img src="modules/assets/img/icons/total-sales.svg" alt="img">
							</div>
					...
					<div class="col-xl-3 col-sm-6 col-12 d-flex">
						<div class="card color-info bg-secondary flex-fill mb-4">
							<div class="mb-2">
								<img src="modules/assets/img/icons/purchased-earnings.svg" alt="img">
							</div>
										...
										<tbody>
												...
												<td class="pt-0 ps-0">
													<div class="d-flex align-items-center">
														<a href="product-list.html" class="avatar avatar-lg me-2">
															<img src="modules/assets/img/products/stock-img-01.png" alt="img">
														</a>
														<div>
											...
											<tr>
												<td class="ps-0">
													<div class="d-flex align-items-center">
														<a href="product-list.html" class="avatar avatar-lg me-2">
															<img src="modules/assets/img/products/stock-img-02.png" alt="img">
														</a>
														<div>
											...
											<tr>
												<td class="ps-0">
													<div class="d-flex align-items-center">
														<a href="product-list.html" class="avatar avatar-lg me-2">
															<img src="modules/assets/img/products/stock-img-06.png" alt="img">
														</a>
														<div>
											...
											<tr>
												<td class="ps-0">
													<div class="d-flex align-items-center">
														<a href="product-list.html" class="avatar avatar-lg me-2">
															<img src="modules/assets/img/products/stock-img-03.png" alt="img">
														</a>
														<div>
											...
											<tr>
												<td class="ps-0">
													<div class="d-flex align-items-center">
														<a href="product-list.html" class="avatar avatar-lg me-2">
															<img src="modules/assets/img/products/stock-img-04.png" alt="img">
														</a>
														<div>
										...
										<tbody>
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="product-list.html" class="avatar avatar-lg me-2">
															<img src="modules/assets/img/products/stock-img-05.png" alt="img">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="product-list.html" class="avatar avatar-lg me-2">
															<img src="modules/assets/img/products/expire-product-01.png" alt="img">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="product-list.html" class="avatar avatar-lg me-2">
															<img src="modules/assets/img/products/expire-product-02.png" alt="img">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="product-list.html" class="avatar avatar-lg me-2">
															<img src="modules/assets/img/products/expire-product-03.png" alt="img">
														</a>
														<div>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<a href="product-list.html" class="avatar avatar-lg me-2">
															<img src="modules/assets/img/products/expire-product-04.png" alt="img">
														</a>
														<div>
