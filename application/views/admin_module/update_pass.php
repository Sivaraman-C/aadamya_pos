      ...
      <div class="account-content">
        <div class="login-wrapper bg-img">
                    <div class="login-content authent-content">
                        <form method="POST" action="<?php echo base_url('uppass'); ?>">
                               ...
                               <div class="login-userheading">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="contact_no" class="form-control border-end-0"  onkeypress="if(this.value.length === 10)return false;" >
                                ...
                                <div class="mb-3">
								    ...
								    <div class="pass-group">
								        <input type="password" name="old_password" class="pass-input form-control" onkeypress="if(this.value.length === 6)return false;">
                                ...
                                <div class="mb-3">
								    ...
								    <div class="pass-group">
								        <input type="password" name="new_password" class="pass-input form-control" onkeypress="if(this.value.length === 6)return false;">
								        <span class="ti toggle-password ti-eye-off text-gray-9"></span>
								    </div>
								</div>
                                <div class="mb-3">
								    ...
								    <div class="pass-group">
								        <input type="password" name="confirm_password" class="pass-input form-control" onkeypress="if(this.value.length === 6)return false;">
								        <span class="ti toggle-password ti-eye-off text-gray-9"></span>
								    </div>
								</div>
