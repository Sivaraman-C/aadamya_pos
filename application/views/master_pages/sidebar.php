			...
			<div class="modern-profile p-3 pb-0">
				<div class="text-center rounded bg-light p-3 mb-4 user-profile">
					<div class="avatar avatar-lg online mb-3">
						<img src="<?php echo base_url(); ?>modules/assets/img/customer/customer15.jpg" alt="Img" class="img-fluid rounded-circle">
					</div>
				...
				<div class="sidebar-nav mb-3">
					<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified bg-transparent" role="tablist">
						<li class="nav-item"><a class="nav-link active border-0" href="product-list.html#">Menu</a></li>
				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
							...
							<ul>
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="<?php echo base_url('sales_dashboard'); ?>">Sales Dashboard</a></li>
									</ul>
								</li>
							</ul>
						</li>
						<li class="submenu-open">
							...
							<ul>
								<li><a href="<?php echo base_url('product_list'); ?>" class="active"><i data-feather="box"></i><span>Products</span></a></li>
								<li><a href="<?php echo base_url('add_product'); ?>"><i class="ti ti-table-plus fs-16 me-2"></i><span>Create Product</span></a></li>
							</ul>
						</li>
						<li class="submenu-open">
							<h6 class="submenu-hdr">Stock</h6>
							<ul>
								<li><a href="<?php echo base_url('manage-stock'); ?>"><i class="ti ti-stack-3 fs-16 me-2"></i><span>Manage Stock</span></a></li>
							</ul>
						</li>
						...
						<li class="submenu-open">
							...
							<ul>
								<li><a href="<?php echo base_url('sales-report') ?>"><i class="ti ti-chart-bar fs-16 me-2"></i><span>Sales Report</span></a></li>
								<li><a href="<?php echo base_url('purchase-report') ?>"><i class="ti ti-chart-pie-2 fs-16 me-2"></i><span>Purchase report</span></a></li>
								<li><a href="<?php echo base_url('inventory-report') ?>"><i class="ti ti-triangle-inverted fs-16 me-2"></i><span>Inventory Report</span></a>
								</li>
								<li><a href="<?php echo base_url('profit-loss') ?>"><i class="ti ti-chart-donut fs-16 me-2"></i><span>Profit & Loss</span></a></li>
							</ul>
						</li>
						<li class="submenu-open">
							<h6 class="submenu-hdr">Pages</h6>
							<ul>
								<li><a href="<?php echo base_url('profile') ?>"><i class="ti ti-user-circle fs-16 me-2"></i><span>Profile</span></a></li>
							</ul>
						</li>
						<li class="submenu-open">
							...
							<ul>
								<li>
									<a href="<?php echo base_url('uppass') ?>"><i class="ti ti-settings fs-16 me-2"></i><span>General Settings</span></a>
								</li>
								<li>
									<a href="<?php echo base_url('adminLogout') ?>"><i class="ti ti-logout fs-16 me-2"></i><span>Logout</span> </a>
								</li>
							</ul>
						</li>
					</ul>
									...
									<ul>
										<li class="submenu submenu-two"><a href="javascript:void(0);">Invoice<span class="menu-arrow inside-submenu"></span></a>
											<ul>
												...
												<li><a href="https://dreamspos.dreamstechnologies.com/html/template/invoice-template.html">Invoice Template</a></li>
											</ul>
										</li>
									...
									<ul>
										<li class="submenu submenu-two"><a href="javascript:void(0);">Email<span class="menu-arrow inside-submenu"></span></a>
											<ul>
												...
												<li><a href="https://dreamspos.dreamstechnologies.com/html/template/email-template.html">Email Template</a></li>
											</ul>
										</li>
										<li class="submenu submenu-two"><a href="javascript:void(0);">SMS<span class="menu-arrow inside-submenu"></span></a>
											<ul>
												<li><a href="sms-settings.html">SMS Settings</a></li>
												<li><a href="https://dreamspos.dreamstechnologies.com/html/template/sms-template.html">SMS Template</a></li>
											</ul>
										</li>
				...
				<div class="twocol-mini">
					<div class="sidebar-left slimscroll">
						<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
							...
							<a href="product-list.html#" class="nav-link " title="Dashboard" data-bs-toggle="tab" data-bs-target="#dashboard">
								<i class="ti ti-smart-home"></i>
							</a>
							<a href="product-list.html#" class="nav-link " title="Super Admin" data-bs-toggle="tab" data-bs-target="#super-admin">
								<i class="ti ti-user-star"></i>
							</a>
							<a href="product-list.html#" class="nav-link " title="Apps" data-bs-toggle="tab" data-bs-target="#application">
								<i class="ti ti-layout-grid-add"></i>
							</a>
							<a href="product-list.html#" class="nav-link" title="Layout" data-bs-toggle="tab" data-bs-target="#layout">
								<i class="ti ti-layout-board-split"></i>
							</a>
							<a href="product-list.html#" class="nav-link active" title="Inventory" data-bs-toggle="tab" data-bs-target="#inventory">
								<i class="ti ti-table-plus"></i>
							</a>
							<a href="product-list.html#" class="nav-link" title="Stock" data-bs-toggle="tab" data-bs-target="#stock">
								<i class="ti ti-stack-3"></i>
							</a>
							<a href="product-list.html#" class="nav-link" title="Sales" data-bs-toggle="tab" data-bs-target="#sales">
								<i class="ti ti-device-laptop"></i>
							</a>
							<a href="product-list.html#" class="nav-link" title="Finance" data-bs-toggle="tab" data-bs-target="#finance">
								<i class="ti ti-shopping-cart-dollar"></i>
							</a>
							<a href="product-list.html#" class="nav-link" title="Hrm" data-bs-toggle="tab" data-bs-target="#hrm">
								<i class="ti ti-cash"></i>
							</a>
							<a href="product-list.html#" class="nav-link" title="Reports" data-bs-toggle="tab" data-bs-target="#reports">
								<i class="ti ti-license"></i>
							</a>
							<a href="product-list.html#" class="nav-link" title="Pages" data-bs-toggle="tab" data-bs-target="#pages">
								<i class="ti ti-page-break"></i>
							</a>
							<a href="product-list.html#" class="nav-link" title="Settings" data-bs-toggle="tab" data-bs-target="#settings">
								<i class="ti ti-lock-check"></i>
							</a>
							<a href="product-list.html#" class="nav-link " title="UI Elements" data-bs-toggle="tab" data-bs-target="#ui-elements">
								<i class="ti ti-ux-circle"></i>
							</a>
							<a href="product-list.html#" class="nav-link" title="Extras" data-bs-toggle="tab" data-bs-target="#extras">
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade" id="stock">
								<ul>
									...
									<li><a href="<?php echo base_url('manage-stock'); ?>"><span>Manage Stock</span></a></li>
								</ul>
							</div>
