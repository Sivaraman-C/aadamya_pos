...
<html class="no-js" lang="en">
  <head>
    ...
    <!-- Favicon Icon -->
    <link rel="icon" href="<?php echo base_url(); ?>modules/ui_temp/assets/img/favicon.png" />
    <!-- Site Title -->
    <title>Posing Landing Page</title>
    <link rel="stylesheet" href="<?php echo base_url(); ?>modules/ui_temp/assets/css/plugins/bootstrap.min.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>modules/ui_temp/assets/css/plugins/slick.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>modules/ui_temp/assets/css/plugins/animate.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>modules/ui_temp/assets/css/style.css" />
  </head>
  ...
  <body>
        ...
        <div class="container">
          <div class="cs-main_header_in">
            <div class="cs-main_header_left">
              <a class="cs-site_branding cs-accent_color" href="<?php echo base_url(); ?>">
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/logo.svg" alt="Logo" />
              </a>
            </div>
            <div class="cs-main_header_center">
              <div class="cs-nav">
                <ul class="cs-nav_list">
                  <li><a href="<?php echo base_url(); ?>#home" class="cs-smoth_scroll">Home</a></li>
            ...
            <div class="cs-main_header_right">
              <div class="cs-toolbox">
                <span class="cs-link cs-modal_btn" data-modal="login"><a href="<?php echo base_url('signin'); ?>" >Login</a></span>
                <div class="page-btn">
                    <a href="<?php echo base_url('register'); ?>" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-stock"><i class="ti ti-circle-plus me-1"></i>Get Start</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div id="home">
      ...
      <section
        class="cs-hero cs-style1 cs-bg"
        data-src="<?php echo base_url(); ?>modules/ui_temp/assets/img/hero_bg.svg"
      >
        <div class="container">
          <div class="cs-hero_img">
            <div
              class="cs-hero_img_bg cs-bg"
              data-src="<?php echo base_url(); ?>modules/ui_temp/assets/img/hero_img_bg.png"
            ></div>
            <img
              src="<?php echo base_url(); ?>modules/ui_temp/assets/img/hero_img.png"
              alt="Hero Image"
          ...
          <div class="cs-hero_text">
            ...
            <div class="cs-hero_subtitle">
              Start selling in minutes with our intuitive POS System.
              <br />Perfect for any business, on any device.
              ...
              <ul class="cs-list cs-style1 cs-mp0">
                <li>
                  <span class="cs-list_icon">
                    <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/tick.svg" alt="Tick" />
                  </span>
                  <div class="cs-list_right">
                    <h5>Free for all users</h5>
                  </div>
                </li>
                <li>
                  <span class="cs-list_icon">
                ...
                <li>
                  ...
                  <div class="cs-list_right">
                    <h5>Workes on desktop, tablet, and mobile</h5>
                  </div>
                </li>
              </ul>
            </div>
            <a href="<?php echo base_url('register'); ?>" class="cs-btn"><span>Get Start</span></a>
          </div>
          <div class="cs-hero_shapes">
            <div class="cs-shape cs-shape_position1">
              <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/shape/shape_1.svg" alt="Shape" />
            </div>
            <div class="cs-shape cs-shape_position2">
              <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/shape/shape_2.svg" alt="Shape" />
            </div>
            <div class="cs-shape cs-shape_position3">
              <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/shape/shape_3.svg" alt="Shape" />
            </div>
            <div class="cs-shape cs-shape_position4">
              <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/shape/shape_4.svg" alt="Shape" />
            </div>
            <div class="cs-shape cs-shape_position5">
              <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/shape/shape_5.svg" alt="Shape" />
            </div>
            <div class="cs-shape cs-shape_position6">
              <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/shape/shape_6.svg" alt="Shape" />
            </div>
          </div>
        </div>
      </section>
    ...
    <!-- Start Main Feature -->
    <section class="cs-bg" data-src="<?php echo base_url(); ?>modules/ui_temp/assets/img/feature_bg.svg">
      <div class="cs-height_95 cs-height_lg_70"></div>
      <div class="container">
        <div class="cs-seciton_heading cs-style1 text-center">
          <div
            class="cs-section_subtitle wow fadeInUp"
            data-wow-duration="1s"
            data-wow-delay="0.3s"
          >
            Office & Inventory
        ...
        <div class="row">
          <div class="col-md-6 col-xl-3">
            ...
            <div class="cs-iconbox cs-style1">
              <div class="cs-iconbox_icon cs-center">
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/icon_box_1.svg" alt="Icon" />
              </div>
          ...
          <div class="col-md-6 col-xl-3">
            <div class="cs-iconbox cs-style1">
              <div class="cs-iconbox_icon cs-center">
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/icon_box_2.svg" alt="Icon" />
              </div>
              <div class="cs-iconbox_in">
          ...
          <div class="col-md-6 col-xl-3">
            ...
            <div class="cs-iconbox cs-style1">
              <div class="cs-iconbox_icon cs-center">
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/icon_box_3.svg" alt="Icon" />
              </div>
              <div class="cs-iconbox_in">
          ...
          <div class="col-md-6 col-xl-3">
            <div class="cs-iconbox cs-style1">
              <div class="cs-iconbox_icon cs-center">
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/icon_box_4.svg" alt="Icon" />
              </div>
              <div class="cs-iconbox_in">
          ...
          >
            <div class="cs-left_full_width cs-space110">
              <div class="cs-left_sided_img">
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/about_img_1.png" alt="About" />
              </div>
            </div>
          </div>
          <div class="col-xl-6">
            ...
            <div class="cs-list_1_wrap">
              <ul class="cs-list cs-style1 cs-mp0">
                ...
                <li>
                  ...
                  <div class="cs-list_right">
                    <h3>Comprehensive Sales & Inventory Tools</h3>
                    <p>
                      Track real-time inventory, monitor sales trends, and manage your stock with accuracy and confidence.
                    </p>
                  </div>
                </li>
                <li>
                  ...
                  <div class="cs-list_right">
                    <h3>Seamless Checkout Experience</h3>
                    <p>
                      Speed up customer transactions with fast, intuitive, and customizable checkout features.
                    </p>
                  </div>
                </li>
                <li>
                  ...
                  <div class="cs-list_right">
                    ...
                    <p>
                      Access your POS from desktop, tablet, or mobile — anytime, anywhere.
                    </p>
                  </div>
                </li>
                <li>
                  ...
                  <div class="cs-list_right">
                    <h3>Staff & Permissions Management</h3>
                    <p>
                      Assign roles and control access for different staff levels with ease.
                    </p>
                  </div>
                </li>
              </ul>
              <div
                class="cs-list_img wow fadeInUp"
                data-wow-duration="1s"
                data-wow-delay="0.5s"
              >
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/about_img_2.png" alt="About" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="cs-funfact_1_wrap cs-type1">
        <div class="cs-funfact cs-style1">
          <div class="cs-funfact_icon cs-center">
            <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/funfact_icon_1.svg" alt="Icon" />
          </div>
        ...
        <div class="cs-funfact cs-style1">
          <div class="cs-funfact_icon cs-center">
            <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/funfact_icon_2.svg" alt="Icon" />
          </div>
          <div class="cs-funfact_right">
            <div class="cs-funfact_number cs-primary_font">
        ...
        <div class="cs-funfact cs-style1">
          <div class="cs-funfact_icon cs-center">
            <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/funfact_icon_3.svg" alt="Icon" />
          </div>
          <div class="cs-funfact_right">
            <div class="cs-funfact_number cs-primary_font">
        ...
        <div class="cs-funfact cs-style1">
          <div class="cs-funfact_icon cs-center">
            <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/funfact_icon_4.svg" alt="Icon" />
          </div>
          <div class="cs-funfact_right">
            <div class="cs-funfact_number cs-primary_font">
          ...
          <div class="row">
            <div class="col-xl-4 col-md-6">
              <div class="cs-iconbox cs-style1 cs-type1">
                <div class="cs-iconbox_icon cs-center">
                  <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/icon_box_5.svg" alt="Icon" />
                </div>
                <div class="cs-iconbox_in">
            ...
            <div class="col-xl-4 col-md-6">
              <div class="cs-iconbox cs-style1 cs-type1">
                <div class="cs-iconbox_icon cs-center">
                  <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/icon_box_6.svg" alt="Icon" />
                </div>
                <div class="cs-iconbox_in">
            ...
            <div class="col-xl-4 col-md-6">
              <div class="cs-iconbox cs-style1 cs-type1">
                <div class="cs-iconbox_icon cs-center">
                  <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/icon_box_7.svg" alt="Icon" />
                </div>
                <div class="cs-iconbox_in">
            ...
            <div class="col-xl-4 col-md-6">
              <div class="cs-iconbox cs-style1 cs-type1">
                <div class="cs-iconbox_icon cs-center">
                  <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/icon_box_8.svg" alt="Icon" />
                </div>
                <div class="cs-iconbox_in">
            ...
            <div class="col-xl-4 col-md-6">
              <div class="cs-iconbox cs-style1 cs-type1">
                <div class="cs-iconbox_icon cs-center">
                  <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/icon_box_9.svg" alt="Icon" />
                </div>
                <div class="cs-iconbox_in">
            ...
            <div class="col-xl-4 col-md-6">
              <div class="cs-iconbox cs-style1 cs-type1">
                <div class="cs-iconbox_icon cs-center">
                  <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/icon_box_10.svg" alt="Icon" />
                </div>
                <div class="cs-iconbox_in">
        ...
        <div class="row align-items-center flex-column-reverse-lg">
          <div class="col-xl-6">
            <div class="cs-left_full_width cs-space40">
              <div class="cs-left_sided_img">
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/retail-store.png" alt="Retail Stores" />
              </div>
            </div>
          </div>
          <div class="col-xl-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="cs-iconbox cs-style2 text-center">
                      <div class="cs-iconbox_icon">
                        <img
                          src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/retail_icon_1.svg"
                          alt="Icon"
                        />
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="cs-iconbox cs-style2 text-center">
                      <div class="cs-iconbox_icon">
                        <img
                          src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/retail_icon_2.svg"
                          alt="Icon"
                        />
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="cs-iconbox cs-style2 text-center">
                      <div class="cs-iconbox_icon">
                        <img
                          src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/retail_icon_3.svg"
                          alt="Icon"
                        />
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="cs-iconbox cs-style2 text-center">
                      <div class="cs-iconbox_icon">
                        <img
                          src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/retail_icon_4.svg"
                          alt="Icon"
                        />
                      </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="cs-iconbox cs-style2 text-center">
                      <div class="cs-iconbox_icon">
                        <img
                          src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/retail_icon_5.svg"
                          alt="Icon"
                        />
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="cs-iconbox cs-style2 text-center">
                      <div class="cs-iconbox_icon">
                        <img
                          src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/retail_icon_6.svg"
                          alt="Icon"
                        />
                      </div>
    ...
    <!-- End Retail Stores -->
    <!-- Start Price Section -->
    <section class="cs-bg" data-src="<?php echo base_url(); ?>modules/ui_temp/assets/img/feature_bg.svg" id="pricing">
      <div class="cs-height_95 cs-height_lg_70"></div>
      <div class="container">
        <div class="cs-seciton_heading cs-style1 text-center">
          <div
            ...
            <div class="cs-pricing_table cs-style1">
              <div class="cs-pricing_head">
                <div class="cs-pricing_heading">
                  <div class="cs-pricing_icon cs-center">
                    <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/pricing_icon_1.svg" alt="Icon" />
                  </div>
              ...
              <div class="cs-pricing_body">
                ...
                <div class="cs-pricing_btn">
                  <a href="index.html#" class="cs-btn cs-size_md"><span>Buy Now</span></a>
                </div>
              </div>
            </div>
            <div class="cs-height_25 cs-height_lg_25"></div>
          ...
          <div class="col-lg-4">
            <div class="cs-pricing_table cs-style1">
              <div class="cs-pricing_head">
                <div class="cs-pricing_heading">
                  <div class="cs-pricing_icon cs-center">
                    <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/pricing_icon_2.svg" alt="Icon" />
                  </div>
          ...
          <div class="col-lg-4">
            <div class="cs-pricing_table cs-style1">
              <div class="cs-pricing_head">
                <div class="cs-pricing_heading">
                  <div class="cs-pricing_icon cs-center">
                    <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/pricing_icon_3.svg" alt="Icon" />
                  </div>
            ...
            <div class="cs-slider_wrapper">
              <div class="cs-slide">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_meta">
                    <div class="cs-avatar">
                      <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/avatar_1.png" alt="Avatar" />
                    ...
                    <div class="cs-testimonial_meta_right">
                      ...
                      <div class="cs-review" data-review="4">
                        <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/stars.svg" alt="Star" />
              ...
              <div class="cs-slide">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_meta">
                    <div class="cs-avatar">
                      <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/avatar_2.png" alt="Avatar" />
                      <div class="cs-quote cs-center">
                        <svg
                          width="19"
                          height="15"
              ...
              <div class="cs-slide">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_meta">
                    <div class="cs-avatar">
                      <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/avatar_3.png" alt="Avatar" />
                      <div class="cs-quote cs-center">
                        <svg
                          width="19"
                          height="15"
            ...
            <div class="cs-slider_wrapper">
              <div class="cs-slide">
                <div class="cs-client cs-accent_bg cs-center">
                  <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/client_1.svg" alt="Client" />
                </div>
              </div>
              <!-- .cs-slide -->
              <div class="cs-slide">
                <div class="cs-client cs-accent_bg cs-center">
                  <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/client_2.svg" alt="Client" />
                </div>
              </div>
              <!-- .cs-slide -->
              <div class="cs-slide">
                <div class="cs-client cs-accent_bg cs-center">
                  <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/client_3.svg" alt="Client" />
                </div>
              </div>
              <!-- .cs-slide -->
              <div class="cs-slide">
                <div class="cs-client cs-accent_bg cs-center">
                  <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/client_4.svg" alt="Client" />
                </div>
              </div>
              <!-- .cs-slide -->
              <div class="cs-slide">
                <div class="cs-client cs-accent_bg cs-center">
                  <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/client_5.svg" alt="Client" />
                </div>
              </div>
              <!-- .cs-slide -->
              <div class="cs-slide">
                <div class="cs-client cs-accent_bg cs-center">
                  <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/client_6.svg" alt="Client" />
                </div>
              </div>
              <!-- .cs-slide -->
              <div class="cs-slide">
      ...
      <div class="container">
        <div class="row align-items-center flex-column-reverse-lg">
          ...
          >
            <div class="cs-left_full_width cs-space110">
              <div class="cs-left_sided_img">
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/faq_img.png" alt="About" />
              </div>
            </div>
            <div class="cs-height_0 cs-height_lg_40"></div>
          </div>
          <div class="col-xl-6">
            <div
              class="cs-accordians cs-style1 wow fadeIn"
              data-wow-duration="1s"
              data-wow-delay="0.4s"
            >
    ...
    <!-- End Post Section -->
    <section class="cs-bg" data-src="<?php echo base_url(); ?>modules/ui_temp/assets/img/feature_bg.svg" id="news">
      <div class="cs-height_95 cs-height_lg_70"></div>
      <div class="container">
        <div class="cs-seciton_heading cs-style1 text-center">
          <div
                ...
                <div class="cs-post cs-style1">
                  <div class="cs-post_thumb cs-modal_btn" data-modal="details">
                    <div
                      ...
                      data-src="<?php echo base_url(); ?>modules/ui_temp/assets/img/post_1.jpeg"
                    ></div>
                  </div>
              ...
              <div class="cs-slide">
                <div class="cs-post cs-style1">
                  <div class="cs-post_thumb cs-modal_btn" data-modal="details">
                    <div
                      class="cs-post_thumb_in cs-bg"
                      data-src="<?php echo base_url(); ?>modules/ui_temp/assets/img/post_2.jpeg"
                    ></div>
                  </div>
                  <div class="cs-post_info">
                    <ul class="cs-post_meta cs-mp0">
              ...
              <div class="cs-slide">
                <div class="cs-post cs-style1">
                  <div class="cs-post_thumb cs-modal_btn" data-modal="details">
                    <div
                      class="cs-post_thumb_in cs-bg"
                      data-src="<?php echo base_url(); ?>modules/ui_temp/assets/img/post_3.jpeg"
                    ></div>
                  </div>
                  <div class="cs-post_info">
                    <ul class="cs-post_meta cs-mp0">
              ...
              <div class="cs-slide">
                <div class="cs-post cs-style1">
                  <div class="cs-post_thumb cs-modal_btn" data-modal="details">
                    <div
                      class="cs-post_thumb_in cs-bg"
                      data-src="<?php echo base_url(); ?>modules/ui_temp/assets/img/post_4.jpeg"
                    ></div>
                  </div>
                  <div class="cs-post_info">
                    <ul class="cs-post_meta cs-mp0">
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-8">
            ...
            <div class="cs-iconbox cs-style3">
              <div class="cs-iconbox_icon">
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/contact_icon_1.svg" alt="Icon" />
              </div>
            ...
            <div class="cs-iconbox cs-style3">
              <div class="cs-iconbox_icon">
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/contact_icon_2.svg" alt="Icon" />
              </div>
              <div class="cs-iconbox_right">
            ...
            <div class="cs-iconbox cs-style3">
              <div class="cs-iconbox_icon">
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/icons/contact_icon_3.svg" alt="Icon" />
              </div>
              <div class="cs-iconbox_right">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="cs-footer_item">
              <div class="cs-footer_widget_text">
                <img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/logo_footer.svg" alt="Logo" />
                <p>
              ...
              <div class="cs-social_btns cs-style1">
                <a href="index.html#"
                  ><img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/facebook.svg" alt="Facebook"
                /></a>
                <a href="index.html#"
                  ><img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/twitter.svg" alt="Twitter"
                /></a>
                <a href="index.html#"
                  ><img src="<?php echo base_url(); ?>modules/ui_temp/assets/img/instagram.svg" alt="Instagram"
                /></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="cs-footer_item widget_nav_menu">
              ...
              <ul class="menu">
                <li><a href="index.html#">Food Delivery</a></li>
                <li><a href="index.html#">Furniture Store</a></li>
                <li><a href="index.html#">Coffee Shop</a></li>
                <li><a href="index.html#">Clothing Store</a></li>
      ...
      <div class="cs-modal_in">
        <div class="cs-modal_container cs-white_bg">
          ...
          <div class="cs-blog_details">
            ...
            <img
              src="<?php echo base_url(); ?>modules/ui_temp/assets/img/post_details_1.jpeg"
              alt="Details"
              class="cs-radius_10 w-100"
            />
            ...
            <div class="row">
              <div class="col-lg-6">
                <img
                  src="<?php echo base_url(); ?>modules/ui_temp/assets/img/post_details_2.jpeg"
                  alt="Details"
                  class="cs-radius_10 w-100"
                />
              </div>
              <div class="col-lg-6">
                <img
                  src="<?php echo base_url(); ?>modules/ui_temp/assets/img/post_details_3.jpeg"
                  alt="Details"
                  class="cs-radius_10 w-100"
                />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <img
                  src="<?php echo base_url(); ?>modules/ui_temp/assets/img/post_details_4.jpeg"
                  alt="Details"
                  class="cs-radius_10 w-100"
                />
              </div>
                ...
                <li>
                  <div class="comment-body">
                    <div class="comment-author">
                      <img
                        alt="Avatar"
                        src="<?php echo base_url(); ?>modules/ui_temp/assets/img/avatar_4.png"
                        class="avatar"
                      />
                      <cite class="fn"><a href="index.html#">Menila</a></cite>
                    </div>
                    <div class="comment-meta"><a href="index.html#">20 Apr, 2020</a></div>
                    <p>
                    ...
                    <div class="reply"><a href="index.html#">Reply</a></div>
                  </div>
                  <ol class="children">
                    <li>
                      <div class="comment-body">
                        <div class="comment-author">
                          <img
                            alt="Avatar"
                            src="<?php echo base_url(); ?>modules/ui_temp/assets/img/avatar_5.png"
                            class="avatar"
                          />
                          <cite class="fn"><a href="index.html#">Karla Swit</a></cite>
                        </div>
                        <div class="comment-meta">
                          <a href="index.html#">9 May, 2020</a>
                        </div>
                        <p>
                ...
                <li>
                  <div class="comment-body">
                    <div class="comment-author">
                      <img
                        alt="Avatar"
                        src="<?php echo base_url(); ?>modules/ui_temp/assets/img/avatar_6.png"
                        class="avatar"
                      />
                      <cite class="fn"><a href="index.html#">George Steven</a></cite>
                    </div>
                    <div class="comment-meta">
                      <a href="index.html#">November 24, 2020</a>
                    </div>
                    <p>Great work</p>
                    <div class="reply"><a href="index.html#">Reply</a></div>
                  </div>
    ...
    <!-- Script -->
    <script src="<?php echo base_url(); ?>modules/ui_temp/assets/js/plugins/jquery-3.6.0.min.js"></script>
    <script src="<?php echo base_url(); ?>modules/ui_temp/assets/js/plugins/jquery.slick.min.js"></script>
    <script src="<?php echo base_url(); ?>modules/ui_temp/assets/js/plugins/jquery.counter.min.js"></script>
    <script src="<?php echo base_url(); ?>modules/ui_temp/assets/js/plugins/wow.min.js"></script>
    <script src="<?php echo base_url(); ?>modules/ui_temp/assets/js/main.js"></script>
  </body>
</html>