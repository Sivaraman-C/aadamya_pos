...
<html lang="en">
  <head>
        ...
        <script src="<?php echo base_url(); ?>modules/assets/js/theme-script.js" type="49cfbb23f64d24b1f657de1d-text/javascript"></script>
        ...
        <!-- Full Calander CSS -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>modules/assets/plugins/fullcalendar/fullcalendar.min.css">
		...
		<!-- Color Picker Css -->
		<link rel="stylesheet" href="<?php echo base_url(); ?>modules/assets/plugins/flatpickr/flatpickr.min.css">
    ...
    <body>
		...
		<div class="header">
			<div class="main-header">
				...
				<a id="mobile_btn" class="mobile_btn" href="calendar.html#sidebar">
					<span class="bar-icon">
						<span></span>
						<span></span>
						<span></span>
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item nav-searchinputs">
						<div class="top-nav-search">
							...
							<form action="calendar.html#" class="dropdown">
								<div class="searchinputs input-group dropdown-toggle" id="dropdownMenuClickable" data-bs-toggle="dropdown" data-bs-auto-close="outside">
									...
									<span class="input-group-text">
										<kbd class="d-flex align-items-center"><img src="<?php echo base_url(); ?>modules/assets/img/icons/command.svg" alt="img" class="me-1">K</kbd>
									</span>
								</div>
								<div class="dropdown-menu search-dropdown" aria-labelledby="dropdownMenuClickable">
									...
									<div class="search-info">
										...
										<ul class="customers">
											<li><a href="javascript:void(0);">Aron Varu<img src="<?php echo base_url(); ?>modules/assets/img/profiles/avator1.jpg" alt="Img" class="img-fluid"></a></li>
											<li><a href="javascript:void(0);">Jonita<img src="<?php echo base_url(); ?>modules/assets/img/profiles/avatar-01.jpg" alt="Img" class="img-fluid"></a></li>
											<li><a href="javascript:void(0);">Aaron<img src="<?php echo base_url(); ?>modules/assets/img/profiles/avatar-10.jpg" alt="Img" class="img-fluid"></a></li>
										</ul>
									</div>
								</div>
							</form>
					...
					<li class="nav-item dropdown has-arrow main-drop select-store-dropdown">
						<a href="javascript:void(0);" class="dropdown-toggle nav-link select-store"
							...
							<span class="user-info">
								<span class="user-letter">
									<img src="<?php echo base_url(); ?>modules/assets/img/store/store-01.png" alt="Store Logo" class="img-fluid">
								</span>
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a href="javascript:void(0);" class="dropdown-item">
								<img src="<?php echo base_url(); ?>modules/assets/img/store/store-01.png" alt="Store Logo" class="img-fluid">Freshmart
							</a>
							<a href="javascript:void(0);" class="dropdown-item">
								<img src="<?php echo base_url(); ?>modules/assets/img/store/store-02.png" alt="Store Logo" class="img-fluid">Grocery Apex
							</a>
							<a href="javascript:void(0);" class="dropdown-item">
								<img src="<?php echo base_url(); ?>modules/assets/img/store/store-03.png" alt="Store Logo" class="img-fluid">Grocery Bevy
							</a>
							<a href="javascript:void(0);" class="dropdown-item">
								<img src="<?php echo base_url(); ?>modules/assets/img/store/store-04.png" alt="Store Logo" class="img-fluid">Grocery Eden
							</a>
						</div>
					</li>
					<!-- /Select Store -->
					...
					<li class="nav-item dropdown nav-item-box">
						...
						<div class="dropdown-menu notifications">
								...
								<ul class="notification-list">
										...
										<a href="activities.html">
											<div class="media d-flex">
												<span class="avatar flex-shrink-0">
													<img alt="Img" src="<?php echo base_url(); ?>modules/assets/img/profiles/avatar-13.jpg">
												</span>
									...
									<li class="notification-message">
										<a href="activities.html">
											<div class="media d-flex">
												<span class="avatar flex-shrink-0">
													<img alt="Img" src="<?php echo base_url(); ?>modules/assets/img/profiles/avatar-03.jpg">
												</span>
												<div class="flex-grow-1">
									...
									<li class="notification-message">
										<a href="activities.html" class="recent-msg">
											<div class="media d-flex">
												<span class="avatar flex-shrink-0">
													<img alt="Img" src="<?php echo base_url(); ?>modules/assets/img/profiles/avatar-17.jpg">
												</span>
												<div class="flex-grow-1">
									...
									<li class="notification-message">
										<a href="activities.html" class="recent-msg">
											<div class="media d-flex">
												<span class="avatar flex-shrink-0">
													<img alt="Img" src="<?php echo base_url(); ?>modules/assets/img/profiles/avatar-02.jpg">
												</span>
												<div class="flex-grow-1">
							...
							<div class="topnav-dropdown-footer d-flex align-items-center gap-3">
								<a href="calendar.html#" class="btn btn-secondary btn-md w-100">Cancel</a>
